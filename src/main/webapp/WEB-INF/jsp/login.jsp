...
<div class="container">
    <div class="lead">
        ...
        Администратор может управлять (редактировать/удалять/создавать) пользователями через UI и по REST интерфейсу с базовой авторизацией. Пользователь может ограниченно редактировать и просматривать свои
        данные
